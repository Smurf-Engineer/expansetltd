...
const About = () => {
  ...
  return (
    ...
    <div className="container-my d-flex align-items-center justify-content-center border shadow-lg rounded py-4">
      ...
      The EXPANSET app revolutionizes the way you shop for clothing, providing an immersive and convenient experience that caters to the diverse fashion needs of individuals and families alike. Seamlessly blending cutting-edge technology with a user-friendly interface, our app serves as a virtual fashion haven where the latest trends in men's, women's, and kids' apparel are just a tap away. Navigating through the app is a breeze, allowing you to explore curated collections, discover new arrivals, and effortlessly make secure purchases with confidence. The app's intuitive features provide a personalized touch, offering tailored recommendations and exclusive deals based on your preferences. Embracing the ethos of EXPANSET, the app is not merely a transactional platform but a dynamic space for self-expression and discovery. It encapsulates the essence of a modern, tech-savvy wardrobe upgrade, where every click opens the door to a world of style possibilities. Your fashion journey begins with the EXPANSET app – download it today to witness the seamless convergence of style, technology, and unparalleled shopping satisfaction.
      </p>
    </div>
